...
def get_parser():
    ...
    parser.add_argument(
        ...
        default="",
        help = """
            The file path of the pre-recorded audio file
        """
    )
...
def get_args(arguments = None, lang: str = "Italian"):
    parser = get_parser()
    ...
    if lang == "Italian":
        args.load_model_dir = "./Italian-EE-conformer"
    else:
        args.load_model_dir = "./English-EE-conformer"
